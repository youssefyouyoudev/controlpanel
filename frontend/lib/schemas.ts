...
export const serviceSchema = z.object({
  name: z.string(),
  label: z.string(),
  status: z.enum(["running", "stopped", "degraded", "unknown", "unavailable"]),
  read_only: z.boolean(),
  checked_at: z.string(),
});
...
export const metricsSchema = z.object({
  ...
  cpu: z.object({ usage_percent: z.number().nullable(), load_average: z.array(z.number()) }),
  memory: z.object({ total_bytes: z.number().nullable(), used_bytes: z.number().nullable(), usage_percent: z.number().nullable() }),
  disk: z.object({ total_bytes: z.number().nullable(), used_bytes: z.number().nullable(), usage_percent: z.number().nullable() }),
  network: z.object({ rx_bytes: z.number().nullable(), tx_bytes: z.number().nullable() }),
