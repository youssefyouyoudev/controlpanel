    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'discovery' => [
                ...
                'project' => $this->metadata['discovery']['project'] ?? null,
                'databases' => $this->metadata['discovery']['databases'] ?? [],
                'discovered_at' => $this->metadata['discovery']['discovered_at'] ?? null,
            ],
            'database_associations' => $this->databases()->get()->map(fn ($database): array => [
                'id' => $database->id,
            ...
            'modules' => [
                ...
                'databases' => $this->databases()->exists() ? 'Available' : 'Needs configuration',
            ],
