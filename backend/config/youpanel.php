...
return [
    ...
    'database_admin' => [
        'enabled' => (bool) env('YOUPANEL_DATABASE_ADMIN_ENABLED', true),
        'driver' => env('YOUPANEL_DATABASE_ADMIN_DRIVER', 'mysql'),
        'host' => env('YOUPANEL_DATABASE_ADMIN_HOST', env('DB_HOST', '127.0.0.1')),
        'port' => (int) env('YOUPANEL_DATABASE_ADMIN_PORT', env('DB_PORT', 3306)),
        'username' => env('YOUPANEL_DATABASE_ADMIN_USERNAME', env('DB_USERNAME')),
        'password' => env('YOUPANEL_DATABASE_ADMIN_PASSWORD', env('DB_PASSWORD')),
